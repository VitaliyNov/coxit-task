...
def main():
    ...
    ap.add_argument("--ckpt", type=str, required=True,
                    help="Path to ConvNeXt checkpoint saved by training script (best.pt/last.pt).")
    ap.add_argument("--model", type=str, default="convnext_tiny",
                    help="timm ConvNeXt name used during training (convnext_tiny/small/base).")
    ...
    ap.add_argument("--outdir", type=str, default="inference_results_convnext")
    ...
    weights_name = ckpt_path.stem  # "best" or "last"
    ...
    (run_outdir / f"{weights_name}_metrics.txt").write_text(
        f"Split: {args.split}\n"
    ...
    print("✅ ConvNeXt inference complete")
